...
public class APFtUtilityAndGlobal {

    /* constants used in ARC-APF Package */
    public final static String APF_IMAGES_PATH       = "/resource/img/";
    public final static String APF_IMAGES_URL        = "../img/";
    public final static String APF_TVB_LOGO_URL      = APF_IMAGES_URL + "slogo.png";
    public final static String APF_TVB_LOGO_PATH     = APF_IMAGES_PATH + "slogo.png";
    public final static String APF_NO_RECORD_FOUND   = "*** NO RECORD FOUND ***";
    public final static String APF_END_OF_REPORT     = "*** END OF REPORT ***";
