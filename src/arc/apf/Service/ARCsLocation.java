...
@Service
public abstract class ARCsLocation extends ACFaAppService{
    
    public ARCsLocation() throws Exception {
        super();
        // TODO Auto-generated constructor stub
    }

    public abstract String getLocationNameById(String supplier_code) throws Exception;//for ajax retrieve AC, 2017/03/10
    public abstract List<ACFiModel> getLocationCode() throws Exception;
}