...
@Service
public abstract class ARCsDirectBudget extends ACFaAppService{
    
    public ARCsDirectBudget() throws Exception {
        super();
        // TODO Auto-generated constructor stub
    }

    public abstract String getSectionNameById(String supplier_code) throws Exception;
    public abstract BigDecimal GenerateSequenceNo(String supplier_code) throws Exception; //generate sequence number for apff011 grid record 2017/03/15
