...
@Repository
public class ARCoIndirectBudget extends ACFaAppDao<ARCmIndirectBudget> { //it should extends the object under Module file source

    public ARCoIndirectBudget() throws Exception {
        super();
    }
