...
@Service
public abstract class ARCsPoDetails extends ACFaAppService{
    
    public ARCsPoDetails() throws Exception {
        super();
    ...
    public abstract String getReferencePrice(String item_no) throws Exception;//
}