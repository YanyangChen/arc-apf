...
//import cal.aes.Model.AESmExtContEventProductCat;
...
@Service
public class ARCsIndirectBudgetImpl extends ARCsIndirectBudget {

    private List<ARCmIndirectBudget> items;

	public ARCsIndirectBudgetImpl() throws Exception {
        super();
        // TODO Auto-generated constructor stub
    }
   
    public void setModel(List<ARCmIndirectBudget> items) throws Exception{
		this.items = items;
		for(ARCmIndirectBudget i : this.items){
			
			i.sub_section_id = i.sub_section_id.replaceAll("^(.*)-(.*)", "$2");
		}
	}
