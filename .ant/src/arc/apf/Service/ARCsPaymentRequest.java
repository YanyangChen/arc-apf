...
@Service
public abstract class ARCsPaymentRequest extends ACFaAppService{
    
    public ARCsPaymentRequest() throws Exception {
        super();
        // TODO Auto-generated constructor stub
    }

    public abstract String getSectionNameById(String supplier_code) throws Exception;
    public abstract List<ACFgRawModel> getPaymentRequestByNo() throws Exception;
    public abstract List<ACFgRawModel> getPaymentRequestByNoCash() throws Exception;
    public abstract String generate_no_pat(String sys_yy, String sys_mm) throws Exception;
    public abstract String generate_no_at(String sys_yy, String sys_mm) throws Exception;
}