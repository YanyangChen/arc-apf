...
@Service
public abstract class ARCsIndirectBudget extends ACFaAppService{
    
    public ARCsIndirectBudget() throws Exception {
        super();
        // TODO Auto-generated constructor stub
    }
    public abstract void setModel(List<ARCmIndirectBudget> items) throws Exception;
