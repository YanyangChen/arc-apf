...
@Service
public abstract class ARCsWPOtherMaterialConsumption extends ACFaAppService{
    
    public ARCsWPOtherMaterialConsumption() throws Exception {
        super();
        // TODO Auto-generated constructor stub
    }

    public abstract String getSectionNameById(String supplier_code) throws Exception;
    public abstract BigDecimal GenerateSequenceNo(String consumption_form_no) throws Exception; //for apwf005 autogen sequence number in grid record
}